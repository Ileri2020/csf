...
const Books = () => (
  <div className="flex flex-col items-center md:justify-center max-w-5xl mx-auto">
    <div className="flex flex-row items-center justify-between m-10 px-2 md:px-10 w-full">
      <div className="text-center text-4xl font-semibold">Books</div>
      <Button variant={"outline"} className="border-accent text-accent text-lg  bg-transparent hover:text-slate-100 hidden md:flex">add book admin</Button>
    </div>
